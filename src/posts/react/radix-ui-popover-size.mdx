---
title: Radix UI Popover - Make the width the same as the trigger
date: 2023-03-29
summary: In this article we will show you how to make the width of the popover the same as the trigger.
tags: react,typescript,radix-ui,web
---
